...
namespace SquadPicker.Data.Migrations
{
    ...
    [Migration("20211122160210_ChangeTeamPlayers")]
    partial class ChangeTeamPlayers
    {
            ...
            modelBuilder.Entity("SquadPicker.Models.Formation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("23cc11ad-f3b9-4a3e-ad03-fd02d9993a2c"),
                            Defenders = 4,
                            Forwards = 2,
                            Goalkeepers = 1,
                            Midfielders = 4,
                        ...
                        new
                        {
                            Id = new Guid("a29123bf-c832-460a-886c-e3d848de5b5f"),
                            Defenders = 5,
                            Forwards = 2,
                            Goalkeepers = 1,
                            Midfielders = 3,
                        ...
                        new
                        {
                            Id = new Guid("a74a3ed1-f780-4908-a697-c8472fe0745f"),
                            Defenders = 4,
                            Forwards = 3,
                            Goalkeepers = 1,
                            Midfielders = 3,
